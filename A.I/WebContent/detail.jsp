	...
	<head>
		...
		<script type="text/javascript">
			function InsFav() {
				...
				document.frm.action = "/semipj/companyfavorite?compName="+document.getElementById("compName").value;
				document.frm.submit();
			}
		</script>
	</head>
	<body>
	<div id="acd" onclick="location.href='search.jsp'">
	<span class="ftext">A</span><span>cademy</span>&nbsp;&nbsp;&nbsp;<span class="stext">I</span><span>nfomation</span>
	</div>
	<span id="bbsw">학원상세정보</span>
	<form action="companymodify" method="post" name="frm">
		<table id="dktt">
			<tr>
				<td id="dk1">학원명 : </td>
			...
			<tr>
				<td><input type="submit" value="수정" id="dk4"/></td>
				<td><a href="companydelete?compName=${company.comp_name }" id="dk5">삭제</a></td>
			</tr>
		</table>
		<input type="hidden" name="userId" value="${company.user_id }"/>
	</form>
	<input type="button" id="btnFav" value="즐겨찾기" onclick="InsFav()" class="dkdk">
	</body>
	<script>
