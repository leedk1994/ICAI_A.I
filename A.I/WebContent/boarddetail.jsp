	            ...
	            <div class="table">
	                ...
	                <div class="row">
	                    ...
	                    <form action="boardmodify.jsp" method="post">
	                        ...
	                        <input class="btn btn-primary btn-block btn-large dkdk" id="modify" type="submit" value="수정"/>
	                    </form>
	                    <button id="delete" class="btn btn-primary btn-block btn-large dkdk" onclick="location.href='boarddelete?bbsno=${dto.bbsno}'">삭제</button>
	                    <p class="line cell"></p>
		                <div class="row">
		                    <div class="cell">
